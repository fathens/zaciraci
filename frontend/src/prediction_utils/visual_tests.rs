...
fn generate_volatile_data_chart(output_dir: &str) {
    let values = vec![
        100.0, 120.0, 90.0, 130.0, 80.0, 140.0, 75.0, 145.0, 70.0, 150.0,
    ];
...
fn generate_iteration_3_improved(output_dir: &str) {
    ...
    let actual_data: Vec<ValueAtTime> = vec![
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 09:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1200.50,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 12:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1205.25,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 15:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1198.75,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-02 09:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1210.00,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-02 12:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1215.80,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-02 15:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1208.40,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-03 09:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1225.60,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-03 12:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1230.25,
        },
    ];
    ...
    let forecast_data: Vec<ValueAtTime> = vec![
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-03 15:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1235.50,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-04 09:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1240.20,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-04 12:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1245.80,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-04 15:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1250.10,
        },
    ];
...
fn test_color_distinction_issue(output_dir: &str) {
    ...
    let actual_data = vec![
        ...
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 18:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1030.0,
        },
    ];
    ...
    let forecast_data = vec![
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 21:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1040.0,
        },
        ValueAtTime {
        ...
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-02 03:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1080.0,
        },
    ];
...
fn test_time_label_issue(output_dir: &str) {
    ...
    let actual_data = vec![
        ...
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 10:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1205.0,
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 11:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1210.0,
        },
    ];
    ...
    let forecast_data = vec![
        ...
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 13:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 1220.0,
        },
    ];
...
fn test_zigzag_pattern_verification() {
    ...
    let actual_data = vec![
        ...
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 14:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
    ...
    let forecast_data = vec![
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 16:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 200.0, // 予測開始（高め）
        },
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 17:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 120.0, // 急降下
        },
        ValueAtTime {
        ...
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 19:00:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(),
            value: 130.0, // 急降下
        },
    ];
...
fn test_time_axis_verification() {
    ...
    let actual_data = vec![
        ...
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 09:15:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(), // 15分後
            value: 110.0,
        },
        ValueAtTime {
    ...
    let forecast_data = vec![
        ...
        ValueAtTime {
            time: NaiveDateTime::parse_from_str("2025-06-01 15:30:00", "%Y-%m-%d %H:%M:%S")
                .unwrap(), // 30分後
            value: 135.0,
        },
        ValueAtTime {
    ...
    for i in 1..actual_data.len() {
        let duration = actual_data[i]
            .time
            .signed_duration_since(actual_data[i - 1].time);
        println!(
            "  {} -> {}: {}分間隔",
    ...
    for i in 1..forecast_data.len() {
        let duration = forecast_data[i]
            .time
            .signed_duration_since(forecast_data[i - 1].time);
...
fn test_legend_position_verification() {
    ...
    // X座標の範囲を確認
    if left_legend_svg.contains("x=\"7")
        || left_legend_svg.contains("x=\"8")
        || left_legend_svg.contains("x=\"9")
    {
...
fn test_extreme_patterns_verification() {
    ...
    for i in 1..actual_data.len() {
        let change_rate =
            (actual_data[i].value - actual_data[i - 1].value) / actual_data[i - 1].value * 100.0;
        println!(
            "  {} -> {}: {:.1}%変化",
            actual_data[i - 1].time.format("%H:%M"),
            actual_data[i].time.format("%H:%M"),
...
pub fn generate_svg_file(
    ...
    fs::write(filename, svg).map_err(|e| format!("ファイル書き込みエラー: {}", e))?;
