...
mod unit_conversion_tests {
    use super::super::algorithms::{
        run_momentum_timestep_simulation, run_portfolio_optimization_simulation,
    };
    ...
    fn test_token_amount_calculation() {
        ...
        // 修正後: 正しい計算
        let price_per_token_near =
            common::units::Units::yocto_f64_to_near_f64(price_per_token_yocto);
