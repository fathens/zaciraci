    ...
    W: blockchain::wallet::Wallet,
{
    ...
    let from_decimals =
        crate::token_cache::get_token_decimals_cached(client, &from_token.to_string()).await?;
    let to_decimals =
        crate::token_cache::get_token_decimals_cached(client, &to_token.to_string()).await?;
    let from_amount =
