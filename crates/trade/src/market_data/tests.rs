...
async fn test_enhanced_liquidity_score_weight_override() {
    ...
    let _guard1 = common::config::store::ConfigGuard::new("LIQUIDITY_VOLUME_WEIGHT", "0.1");
    let _guard2 = common::config::store::ConfigGuard::new("LIQUIDITY_POOL_WEIGHT", "0.9");
...
async fn test_pool_liquidity_error_default_score_override() {
    ...
    // オーバーライド (0.5)
    let _guard = common::config::store::ConfigGuard::new("LIQUIDITY_ERROR_DEFAULT_SCORE", "0.5");
