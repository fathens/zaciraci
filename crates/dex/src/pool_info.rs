...
use crate::token_index::{TokenIn, TokenIndex, TokenOut};
use crate::token_pair::{FEE_DIVISOR, TokenPair, TokenPairId};
use anyhow::Result;
...
impl PoolInfo {
    ...
    pub fn is_empty(&self) -> bool {
        self.bare.token_account_ids.is_empty()
    }
